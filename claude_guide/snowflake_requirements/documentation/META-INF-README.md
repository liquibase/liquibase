...
### services/liquibase.structure.DatabaseObject
**CRITICAL**: Registers custom database object types (Warehouse, etc.) so they are included in default snapshot scope automatically.

**Without this registration**, custom objects will not appear in snapshots even if snapshot generators exist.
