...
SCENARIO_D_FIX_VALIDATION:
  ...
  AUTOMATION_AVAILABLE:
    PROGRAM: "../troubleshooting/systematic-debugging.yaml"
...
**For automated XSD troubleshooting**: Use `../troubleshooting/xsd-resolution.yaml`
...
**For automated incomplete implementation detection**: Use `../troubleshooting/incomplete-detection.yaml`
...
**For automated service registration validation**: Use `../troubleshooting/validation_programs/service-registration-validation.yaml`
...
**For automated architectural compliance validation**: Use `../troubleshooting/validation_programs/architectural-compliance-validation.yaml`
...
**For automated test development guidance**: Use `../troubleshooting/test-development-guidelines-snowflake.yaml`

**For automated systematic debugging**: Use `../troubleshooting/systematic-debugging.yaml` when tests fail

**For automated test file management**: Use `../troubleshooting/test-harness-orphaned-files.yaml` when resolving missing test files
...
**For automated implementation completeness validation**: Use `../troubleshooting/validation_programs/implementation-completeness-validation.yaml`
