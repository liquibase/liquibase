...
**CRITICAL**: Register both the DatabaseObject and SnapshotGenerator for full functionality:

### META-INF/services/liquibase.structure.DatabaseObject
```
liquibase.ext.mydb.database.object.MyObject
```

**Required for default snapshots**: Without this registration, your custom objects will not be included in standard snapshot scope automatically.
