...
public class LiquibaseGenerateChangeLogMojo extends
	...
	protected void performLiquibaseTask(Liquibase liquibase)
        ...
        try {
            CommandLineUtils.doGenerateChangeLog(outputChangeLogFile, database, defaultSchemaName, StringUtils.trimToNull(diffTypes),
                    StringUtils.trimToNull(changeSetAuthor), StringUtils.trimToNull(changeSetContext), StringUtils.trimToNull(dataDir));
