...
public class LiquibaseUpdateMojoExecutionTest extends AbstractLiquibaseMojoTest {
  ...
  private static final String CONFIG_FILE = "update/plugin_config_execution.xml";
...
//	  // Create the properties file for this test
//	    Properties props = new Properties();
//	    props.setProperty("url", "jdbc:derby:test;create=true");
//	    props.setProperty("changeLogFile", "update/relativeClobFileChangeLog.xml");
//	    createPropertiesFile("update/test.properties", props);
//
//	    LiquibaseUpdate mojo = createUpdateMojo();
//	    setVariableValueToObject(mojo, "propertyFile", "update/test.properties");
