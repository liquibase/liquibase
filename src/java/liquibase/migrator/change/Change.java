...
public interface Change {
     ...
     * @throws SQLException if there were problems executing the statements
     ...
     * @throws SQLException if there were problems executing the rollback statements
     * @throws UnsupportedChangeException if this change is not supported by the {@link Database} passed as argument
     ...
     *
     * @param databasethe target {@link Database} associated to this change's rollback statements
