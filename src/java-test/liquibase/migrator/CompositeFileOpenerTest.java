...
public class CompositeFileOpenerTest {
    ...
    public void setUp() throws IOException {
        ...
        validStream = this.getClass().getClassLoader().getResourceAsStream("liquibase/migrator/CompositeFileOpenerTest.class");
        
        empty = new Vector<URL>().elements();
        hasElements = this.getClass().getClassLoader().getResources("liquibase/migrator");
    }
