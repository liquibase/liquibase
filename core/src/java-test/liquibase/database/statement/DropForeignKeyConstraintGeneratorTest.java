...
public class DropForeignKeyConstraintGeneratorTest extends AbstractSqStatementTest {
    ...
    protected DropForeignKeyConstraintStatement createGeneratorUnderTest() {
