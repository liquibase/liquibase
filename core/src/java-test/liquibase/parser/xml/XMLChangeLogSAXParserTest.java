...
public class XMLChangeLogSAXParserTest {
    ...
    public void simpleChangeLog() throws Exception {
        DatabaseChangeLog changeLog = new XMLChangeLogSAXParser().parse("liquibase/parser/xml/simpleChangeLog.xml", new HashMap<String, Object>(), new JUnitResourceAccessor());
    ...
    public void multiChangeSetChangeLog() throws Exception {
        DatabaseChangeLog changeLog = new XMLChangeLogSAXParser().parse("liquibase/parser/xml/multiChangeSetChangeLog.xml", new HashMap<String, Object>(), new JUnitResourceAccessor());
    ...
    public void logicalPathChangeLog() throws Exception {
        DatabaseChangeLog changeLog = new XMLChangeLogSAXParser().parse("liquibase/parser/xml/logicalPathChangeLog.xml", new HashMap<String, Object>(), new JUnitResourceAccessor());
    ...
    public void preconditionsChangeLog() throws Exception {
        DatabaseChangeLog changeLog = new XMLChangeLogSAXParser().parse("liquibase/parser/xml/preconditionsChangeLog.xml", new HashMap<String, Object>(), new JUnitResourceAccessor());
    ...
    public void testNestedChangeLog() throws Exception {
        ...
        DatabaseChangeLog changeLog = new XMLChangeLogSAXParser().parse("liquibase/parser/xml/nestedChangeLog.xml", new HashMap<String, Object>(), new JUnitResourceAccessor());
    ...
    public void malformedChangeLog() throws Exception {
        try {
            DatabaseChangeLog changeLog = new XMLChangeLogSAXParser().parse("liquibase/parser/xml/malformedChangeLog.xml", new HashMap<String, Object>(), new JUnitResourceAccessor());
        } catch (Exception e) {
            assertTrue(e instanceof ChangeLogParseException);
