...
public class AddColumnExecutorTest extends AbstractExecuteTest {
    ...
    public void generateSql_autoIncrement() throws Exception {
        ...
        assertCorrect("alter table [table_name] add [column_name] int identity", MSSQLDatabase.class);
    ...
    public void generateSql_primaryKey() throws Exception {
        ...
        assertCorrect("alter table [table_name] add [column_name] int not null primary key", HsqlDatabase.class, SybaseASADatabase.class, MSSQLDatabase.class, SybaseDatabase.class, MaxDBDatabase.class);
