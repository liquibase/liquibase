# Liquibase [![Main](https://github.com/liquibase/liquibase/actions/workflows/main.yml/badge.svg)](https://github.com/liquibase/liquibase/actions/workflows/main.yml) [![Nightly Release](https://github.com/liquibase/liquibase/actions/workflows/main.yml/badge.svg?event=schedule)](https://github.com/liquibase/liquibase/releases/tag/nightly) [![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=liquibase&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=liquibase)
