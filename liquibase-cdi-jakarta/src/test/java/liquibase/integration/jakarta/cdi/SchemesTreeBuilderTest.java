...
/**
 * @author Nikita Lipatov (https://github.com/islonik), antoermo (https://github.com/dikeert), Jeroen Peschier (https://github.com/xazap)
 * @since 27/5/17.
 */
public class SchemesTreeBuilderTest {
    ...
    private Collection<LiquibaseSchema> list2Coll(List<String> list) {
        ...
        for (String s : list) {
            cdiList.add(String.format("liquibase.integration.jakarta.cdi.%s", s));
        }
