...
class URIResourceAccessorTest extends Specification {
    ...
    def resolveSibling() {
        ...
        "/anotherFile.xml"                               | "jar:file:core.war/WEB-INF/lib/usoi-db-scripts-24.1-plain.jar!/com/asuproject/usoi/db/manage/scripts/oracle/package/anotherJarFile.jar!/anotherFile.xml" | "anotherFile.xml"                          | "jar:file:core.war/WEB-INF/lib/usoi-db-scripts-24.1-plain.jar!/com/asuproject/usoi/db/manage/scripts/oracle/package/anotherJarFile.jar!/anotherFile.xml" | "anotherFile.xml"
    }
}
