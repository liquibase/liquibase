...
class SimpleSqlGrammarTest extends Specification {
    ...
    def test() {
        ...
        "q'~TD SYNNEX Corporation's belong to~'"                       | ["q'~TD SYNNEX Corporation's belong to~'"]
        "INSERT INTO t VALUES (q'~TD SYNNEX Corporation's~');"         | ["INSERT", " ", "INTO", " ", "t", " ", "VALUES", " ", "(", "q'~TD SYNNEX Corporation's~'", ")", ";"]
        "q'[This has an ' inside]'"                                    | ["q'[This has an ' inside]'"]
        "Q'{Capital Q with ' inside}'"                                 | ["Q'{Capital Q with ' inside}'"]
        "nq'<National char set with ' inside>'"                        | ["nq'<National char set with ' inside>'"]
        "q'!abc'def!'"                                                 | ["q'!abc'def!'"]
        "q'#abc'def#'"                                                 | ["q'#abc'def#'"]
        "q'(abc'def)'"                                                 | ["q'(abc'def)'"]
        "q'<abc'def>'"                                                 | ["q'<abc'def>'"]
