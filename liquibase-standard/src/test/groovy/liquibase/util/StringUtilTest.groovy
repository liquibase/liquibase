...
class StringUtilTest extends Specification {
    ...
    def "processMultilineSql examples"() {
        ...
        true          | true            | null         | "INSERT INTO t VALUES (\nq'~TD SYNNEX Corporation's belong to~'\n);"                                                                                                                                 | ["INSERT INTO t VALUES (\nq'~TD SYNNEX Corporation's belong to~'\n)"]
        true          | true            | null         | "SELECT 1; INSERT INTO t VALUES (q'~abc;def~'); SELECT 2;"                                                                                                                                           | ["SELECT 1", "INSERT INTO t VALUES (q'~abc;def~')", "SELECT 2"]
        true          | true            | null         | "SELECT 1;\nINSERT INTO t VALUES (\nq'~abc;\ndef;\nghi~'\n);\nSELECT 2;"                                                                                                                             | ["SELECT 1", "INSERT INTO t VALUES (\nq'~abc;\ndef;\nghi~'\n)", "SELECT 2"]
        true          | true            | null         | "SELECT q'[abc;def]'; SELECT 2;"                                                                                                                                                                      | ["SELECT q'[abc;def]'", "SELECT 2"]
        true          | true            | null         | "INSERT INTO t VALUES (\nq'~first~'\n);\n\nINSERT INTO t VALUES (\nq'~TD SYNNEX Corporation's belong to~'\n);"                                                                                       | ["INSERT INTO t VALUES (\nq'~first~'\n)", "INSERT INTO t VALUES (\nq'~TD SYNNEX Corporation's belong to~'\n)"]
    }
