...
public class FileUtil {
    ...
    public static String getFileNotFoundMessage(String physicalChangeLogLocation) {
        return getFileNotFoundMessage(physicalChangeLogLocation, "");
    }

    public static String getFileNotFoundMessage(String physicalChangeLogLocation, String requiredAt) {
        //
        // Check for any prefix which is not file:
        // Take this to indicate a full path
        //
        if (physicalChangeLogLocation.matches("^\\w\\w+:.*") &&
             ! physicalChangeLogLocation.startsWith("file:")) {
            return "ERROR: The file '" + physicalChangeLogLocation + "' not found." + requiredAt + System.lineSeparator() +
        ...
        StringBuilder builder = new StringBuilder("The file '" + physicalChangeLogLocation + "' not found" + requiredAt +
              " in the configured search path:" + System.lineSeparator());
