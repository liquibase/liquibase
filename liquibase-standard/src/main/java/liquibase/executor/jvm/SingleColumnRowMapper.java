 ...
 */
class SingleColumnRowMapper<T> implements RowMapper<T> {
    ...
    public SingleColumnRowMapper(Class<T> requiredType) {
        if (requiredType == null) {
            throw new NullPointerException("requiredType is missing");
        }
    ...
    public T mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        T result = getColumnValue(rs, 1, this.requiredType);
     ...
     */
    protected T getColumnValue(ResultSet rs, int index, Class<T> requiredType) throws SQLException {
        Object value;
    ...
    protected T convertValueToRequiredType(Object value) {
        if (String.class.equals(this.requiredType)) {
            ...
            if (value instanceof Number) {
                ...
                return (T) ObjectUtil.convert(value, this.requiredType);
            } else {
                // Convert stringified value to target Number class.
                return (T) NumberUtil.parseNumber(value.toString(), (Class<Number>) this.requiredType);
            }
        } else {
