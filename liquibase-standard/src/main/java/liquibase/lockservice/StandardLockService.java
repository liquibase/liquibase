...
public class StandardLockService implements LockService {
    ...
    public void init() throws DatabaseException {
        ...
        if (executor instanceof LoggingExecutor) {
            ...
            if (isHasDatabaseChangeLogLockTable()) {
                maxIterations = 0;
            } else {
                maxIterations = 1;
            }
        ...
        for (int i = 0; i < maxIterations; i++) {
            try {
                if (!isHasDatabaseChangeLogLockTable(true)) {
     ...
     */
    protected boolean isHasDatabaseChangeLogLockTable(boolean forceRecheck) {
    ...
    protected boolean isHasDatabaseChangeLogLockTable() throws DatabaseException {
        return isHasDatabaseChangeLogLockTable(false);
    }
    ...
    public void releaseLock() throws LockException {
        ...
        Executor executor = Scope.getCurrentScope().getSingleton(ExecutorService.class).getExecutor("jdbc", database);
        try {
            if (this.isHasDatabaseChangeLogLockTable()) {
