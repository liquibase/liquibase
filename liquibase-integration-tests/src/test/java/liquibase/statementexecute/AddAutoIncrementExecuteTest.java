...
//        assertCorrect("alter table [table_name] add [column_name] integer default 42", SQLiteDatabase.class);
    ...
    public void notNull() throws Exception {
        ...
        assertCorrect("alter table table_name add column_name integer default 42 not null", OracleDatabase.class, DerbyDatabase.class, HsqlDatabase.class, DB2Database.class, H2Database.class, FirebirdDatabase.class);
        assertCorrect("not supported. fixme!!", SQLiteDatabase.class);
