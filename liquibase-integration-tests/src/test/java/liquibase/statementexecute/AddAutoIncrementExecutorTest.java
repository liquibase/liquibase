...
public class AddAutoIncrementExecutorTest extends AbstractExecutorTest {
...
//        }
    ...
    public void noSchema() throws Exception {
        ...
        assertCorrect("alter table [table_name] modify column_name serial", CockroachDatabase.class);
        assertCorrect("alter table [table_name] modify column_name integer generated by default as identity", PostgresDatabase.class, EnterpriseDBDatabase.class);
        ...
        //Snowflake doesn't support AddAutoIncrement for existing column, only when adding column, exclude it
        testOnAllExcept("ALTER TABLE [table_name] MODIFY [column_name] int AUTO_INCREMENT", SnowflakeDatabase.class);
    }
