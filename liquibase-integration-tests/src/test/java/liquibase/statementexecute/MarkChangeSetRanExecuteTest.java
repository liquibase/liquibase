...
public class MarkChangeSetRanExecuteTest extends AbstractExecuteTest {
    ...
    public void generateSql_update() throws Exception {
        ...
        assertCorrect("update [databasechangelog] set [comments] = '', [contexts] = 'e', [dateexecuted] = current year to fraction(5), deployment_id = " +
                "null, exectype = 'reran', [labels] = null, liquibase = 'dev', md5sum = '9:d41d8cd98f00b204e9800998ecf8427e', orderexecuted = 1 where id " +
        ...
        assertCorrectOnRest("update [databasechangelog] set [comments] = '', [contexts] = 'e', [dateexecuted] = NOW(), [deployment_id] = null, [exectype] = 'reran', [labels] = null, liquibase = 'dev', [md5sum] = " +
