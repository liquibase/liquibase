...
public class UnlockDatabaseChangeLogExecuteTest extends AbstractExecuteTest {
    ...
    public void generateSql() throws Exception {
        ...
        assertCorrect("update [databasechangeloglock] set [locked] = false, [lockedby] = null, [lockgranted] = null where [id] = 1", PostgresDatabase.class, HsqlDatabase.class, H2DatabaseTemp.class);
