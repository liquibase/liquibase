...
public class UnlockDatabaseChangeLogExecuteTest extends AbstractExecuteTest {
    ...
    public void generateSql() throws Exception {
        ...
        assertCorrect("update [databasechangeloglock] set [locked] = 0, [lockedby] = null, [lockedbyid] = null, [lockexpires] = null, [lockgranted] = null where [id] = 1 and lockedbyid  = '9e5f4429-4feb-4cd4-a0b8-c521d9846b4c'", MSSQLDatabase.class, SybaseDatabase.class);
        ...
        assertCorrect("update [databasechangeloglock] set [locked] = false, [lockedby] = null, [lockedbyid] = null, [lockexpires] = null, [lockgranted] = null where [id] = 1 and lockedbyid  = '9e5f4429-4feb-4cd4-a0b8-c521d9846b4c'", PostgresDatabase.class, HsqlDatabase.class, H2Database.class, Ingres9Database.class);
