package liquibase.dbtest.firebird3;
 ...
 */
public class Firebird3IntegrationTest extends AbstractIntegrationTest {

    public Firebird3IntegrationTest() throws Exception {
        super("firebird", DatabaseFactory.getInstance().getDatabase("firebird3"));
    }
