...
public class InformixDatabaseTest extends TestCase {
	...
	public void testGetDateLiteral() {
		...
		TestCase.assertEquals("DATETIME (2010-11-12 13:14:15) YEAR TO FRACTION(5)", d);
		
		d = database.getDateLiteral("2010-11-12");
		TestCase.assertEquals("'2010-11-12'", d);
		
		d = database.getDateLiteral("13:14:15");
		TestCase.assertEquals("INTERVAL (13:14:15) HOUR TO FRACTION(5)", d);
	}
