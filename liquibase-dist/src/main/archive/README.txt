...
H2 Database Program
----------------------------------------
As Liquibase ships with an h2 database for examples, the h2 jdbc driver was placed into the your chosen install directory.
For information on using and configuring the h2 database see https://www.liquibase.org/documentation/tutorials/h2.html


Open JDK
----------------------------------------
We placed AdoptOpenJDK (https://adoptopenjdk.net/) in your chosen install directory.
...
----------------------------------------
The program is subject to license agreement, copyright, trademark, patent and other laws.
Copyright 2020 Datical, LLC. All rights reserved.
