...
class OnlineHubServiceTest extends Specification {
    ...
    def "toSearchString"() {
        ...
        new Environment(prj: new Project(id: testUuid))                                            | "project.id:\"$testUuid\""
        new Environment(prj: new Project(id: testUuid, name: "Test Project"))                      | "project.id:\"$testUuid\""
        new Environment(name: "test name", jdbcUrl: "test://jdbc", prj: new Project(id: testUuid)) | 'jdbcUrl:"test://jdbc" AND name:"test name" AND project.id:"3b8b6f80-1194-4a70-8cf2-30f33fd0433e"'
