...
class CommandFactoryTest extends Specification {
    ...
    def "getCommand brings all the dependencies for a given command in correct oreder"() {
        ...
        command.pipeline*.class*.name == ["liquibase.command.core.DbUrlConnectionCommandStep", "liquibase.command.core.LockServiceCommandStep", "liquibase.command.core.TagCommandStep"]
