...
class CommandScopeTest extends Specification {
    ...
    def "can get and set argument values"() {
        ...
        def arg = new CommandStepBuilder(MockCommandStep).argument(argumentName, String).defaultValue(defaultValue).build()
    ...
    def "execute with failing argument validation"() {
        ...
        new CommandStepBuilder(MockCommandStep).argument("requiredArg", String).required().build()
        new CommandStepBuilder(MockCommandStep).argument("optionalArg", String).optional().build()
