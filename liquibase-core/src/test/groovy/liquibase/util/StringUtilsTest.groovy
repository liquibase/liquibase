...
class StringUtilsTest extends Specification {
    ...
    def "processMultilineSql examples"() {
        ...
        true          | true            | "\\n/"                 | "select 1/x from y\n/\nselect 1/y from x"                                                                                                                                                           | ["select 1/x from y", "select 1/y from x"]
        ...
        true          | true            | "\\u0009"              | "statement 1\tstatement 2\tstatement 3\tstatement 4"                                                                                                                                                | ["statement 1","statement 2", "statement 3", "statement 4"]
        true          | true            | "\\t"                  | "statement 1\tstatement 2\tstatement 3\tstatement 4"                                                                                                                                                | ["statement 1","statement 2", "statement 3", "statement 4"]
        true          | true            | "\\011"                | "statement 1\tstatement 2\tstatement 3\tstatement 4"                                                                                                                                                | ["statement 1","statement 2", "statement 3", "statement 4"]
        true          | true            | "\\x9"                 | "statement 1\tstatement 2\tstatement 3\tstatement 4"                                                                                                                                                | ["statement 1","statement 2", "statement 3", "statement 4"]
        true          | true            | "\\s+"                 | "statement1 statement2 statement3 statement4"                                                                                                                                                | ["statement1","statement2", "statement3", "statement4"]
        true          | true            | '\\n/\\s*\\n|\\n/\\s*$'| "CREATE OR REPLACE PACKAGE my_package IS\nFUNCTION my_function(pi_number IN NUMBER)\n" + "RETURN NUMBER;\n" + "END my_package;\n" + "/\n" + "CREATE OR REPLACE PACKAGE BODY my_package IS\nFUNCTION my_function(pi_number IN NUMBER)\nRETURN NUMBER\nIS\nBEGIN\nRETURN pi_number / 2;\nEND;\nEND my_package;\n/"|["CREATE OR REPLACE PACKAGE my_package IS\nFUNCTION my_function(pi_number IN NUMBER)\n" + "RETURN NUMBER;\n" + "END my_package;", "CREATE OR REPLACE PACKAGE BODY my_package IS\nFUNCTION my_function(pi_number IN NUMBER)\nRETURN NUMBER\nIS\nBEGIN\nRETURN pi_number / 2;\nEND;\nEND my_package;"]
    }
