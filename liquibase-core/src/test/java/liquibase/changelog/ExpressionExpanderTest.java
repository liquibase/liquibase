...
public class ExpressionExpanderTest {
    ...
    @Test
    public void expandExpressions_escapedSimple() throws Exception {
        Scope.child(Collections.singletonMap(ChangeLogParserConfiguration.SUPPORT_PROPERTY_ESCAPING.getKey(), true), () -> {
            this.handler = new ChangeLogParameters.ExpressionExpander(changeLogParameters);
    ...
    @Test
    public void expandExpressions_escapedNonGreedy() throws Exception {
        Scope.child(Collections.singletonMap(ChangeLogParserConfiguration.SUPPORT_PROPERTY_ESCAPING.getKey(), true), () -> {
    ...
    @Test
    public void expandExpressions_escapedMultipleSimple() throws Exception {
        Scope.child(Collections.singletonMap(ChangeLogParserConfiguration.SUPPORT_PROPERTY_ESCAPING.getKey(), true), () -> {
    ...
    @Test
    public void expandExpressions_escapedMultipleComplex() throws Exception {
        Scope.child(Collections.singletonMap(ChangeLogParserConfiguration.SUPPORT_PROPERTY_ESCAPING.getKey(), true), () -> {
            this.handler = new ChangeLogParameters.ExpressionExpander(changeLogParameters);
    ...
    @Test
    public void expandExpressions_escapedBeforeVariable() throws Exception {
        Scope.child(Collections.singletonMap(ChangeLogParserConfiguration.SUPPORT_PROPERTY_ESCAPING.getKey(), true), () -> {
    ...
    @Test
    public void expandExpressions_escapedAfterVariable() throws Exception {
        Scope.child(Collections.singletonMap(ChangeLogParserConfiguration.SUPPORT_PROPERTY_ESCAPING.getKey(), true), () -> {
            this.handler = new ChangeLogParameters.ExpressionExpander(changeLogParameters);
    ...
    @Test
    public void expandExpressions_escapedMultipleComplexVariant() throws Exception {
