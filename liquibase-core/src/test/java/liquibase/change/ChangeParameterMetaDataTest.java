...
public class ChangeParameterMetaDataTest {
    ...
    public void computedDatabasesCorrect(){
        ...
        assertSetsEqual(new String[]{"sybase","mssql","postgresql","firebird","firebird3","oracle","sqlite","mysql","mariadb","h2","hsqldb","db2","ingres"}, replaceIfExists.analyzeSupportedDatabases(new String[]{ChangeParameterMetaData.COMPUTE}));
    }
