...
public class ChangeParameterMetaDataTest {
    ...
    public void constructor() {
        ...
        ChangeParameterMetaData metaData = new ChangeParameterMetaData(new ExampleAbstractChange(),
                ...
                "column",
                LiquibaseSerializable.SerializationType.NESTED_OBJECT);
    ...
    public void isRequiredFor() {
        ...
        assertTrue(new ChangeParameterMetaData(new ExampleAbstractChange(),
                "x",
                "y",
                null,
                null,
                ...
                null,
                null,
                LiquibaseSerializable.SerializationType.NAMED_FIELD).isRequiredFor(new MySQLDatabase()));
        assertTrue(new ChangeParameterMetaData(new ExampleAbstractChange(),
                "x",
                "y",
                null,
                ...
                null,
                null,
                LiquibaseSerializable.SerializationType.NAMED_FIELD).isRequiredFor(new MSSQLDatabase()));
        assertFalse(new ChangeParameterMetaData(new ExampleAbstractChange(),
                "x",
                "y",
                null,
                null,
                ...
                null,
                null,
                LiquibaseSerializable.SerializationType.NAMED_FIELD).isRequiredFor(new OracleDatabase()));
    ...
    public void computedDatabasesCorrect() {
        ...
        assertSetsEqual(new String[] {
                "informix",
                "mssql",
                "mysql",
                "mariadb"
        }, columnDataType.analyzeRequiredDatabases(new String[] {ChangeParameterMetaData.COMPUTE}));
        ...
        assertSetsEqual(new String[] {
                ...
                "db2",
                "ingres"
        }, replaceIfExists.analyzeSupportedDatabases(new String[] {ChangeParameterMetaData.COMPUTE}));
    }
}
