     	...
     	for (Database database : TestContext.getInstance().getAllDatabases()) {
     		if (database instanceof DB2Database || database instanceof DB2Database) {
     			super.testAddAutoIncrementStatement(
     				...
     				null,
     				null,
     				"ALTER TABLE SCHEMA_NAME.TABLE_NAME ALTER COLUMN COLUMN_NAME SET GENERATED BY DEFAULT AS IDENTITY");
     		}
     	}
     }
     	...
     	for (Database database : TestContext.getInstance().getAllDatabases()) {
     		if (database instanceof DB2Database || database instanceof DB2Database) {
     			super.testAddAutoIncrementStatement(
     				...
     				null,
     				"ALTER TABLE SCHEMA_NAME.TABLE_NAME ALTER COLUMN COLUMN_NAME SET GENERATED BY DEFAULT AS IDENTITY (START WITH 2)");
     		}
     	}
     }
     	...
     	for (Database database : TestContext.getInstance().getAllDatabases()) {
     		if (database instanceof DB2Database || database instanceof DB2Database) {
     			super.testAddAutoIncrementStatement(
     				...
     				BigInteger.valueOf(2), 
     				BigInteger.TEN,
     				"ALTER TABLE SCHEMA_NAME.TABLE_NAME ALTER COLUMN COLUMN_NAME SET GENERATED BY DEFAULT AS IDENTITY (START WITH 2, INCREMENT BY 10)");
     		}
     	}
     }
}