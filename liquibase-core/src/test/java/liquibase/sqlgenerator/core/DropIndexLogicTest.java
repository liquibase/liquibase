...
//		DropIndexLogic dropIndexLogic = new DropIndexLogic();
...
//		Sql[] sqls = dropIndexLogic.generateSql(statement, database, sqlGenerationChain);
...
//		sqls = dropIndexLogic.generateSql(statement, database, sqlGenerationChain);
