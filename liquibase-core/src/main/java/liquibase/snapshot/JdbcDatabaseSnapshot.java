...
public class JdbcDatabaseSnapshot extends DatabaseSnapshot {
    ...
    public class CachingDatabaseMetaData {
        ...
        public List<CachedRow> getImportedKeys(final String catalogName, final String schemaName, final String table) throws DatabaseException {
            return getResultSetCache("getImportedKeys").get(new ResultSetCache.ResultSetExtractor(database) {

                @Override
                public ResultSetCache.RowData rowKeyParameters(CachedRow row) {
                    return new ResultSetCache.RowData(row.getString("FKTABLE_CAT"), row.getString("FKTABLE_SCHEM"), database, row.getString("FKTABLE_NAME"));
                }
                ...
                @Override
                public ResultSet fastFetch() throws SQLException {
                    return databaseMetaData.getImportedKeys(catalogName, schemaName, table);
                }

                @Override
                public ResultSet bulkFetch() throws SQLException {
                    return null;
                }
        ...
        public List<CachedRow> getIndexInfo(final String catalogName, final String schemaName, final String table) throws DatabaseException {
            return getResultSetCache("getIndexInfo").get(new ResultSetCache.ResultSetExtractor(database) {
                ...
                @Override
                public ResultSet fastFetch() throws SQLException, DatabaseException {
        ...
        public List<CachedRow> getColumns(final String catalogName, final String schemaName, final String tableName, final String columnName) throws SQLException, DatabaseException {
            return getResultSetCache("getColumns").get(new ResultSetCache.ResultSetExtractor(database) {
        ...
        public List<CachedRow> getTables(final String catalogName, final String schemaName, final String table, final String[] types) throws SQLException, DatabaseException {
            return getResultSetCache("getTables."+StringUtils.join(types, ":")).get(new ResultSetCache.ResultSetExtractor(database) {
        ...
        public List<CachedRow> getPrimaryKeys(final String catalogName, final String schemaName, final String table) throws SQLException, DatabaseException {
            return getResultSetCache("getPrimaryKeys").get(new ResultSetCache.ResultSetExtractor(database) {
        ...
        public List<CachedRow> getUniqueConstraints(final String catalogName, final String schemaName, final String tableName) throws SQLException, DatabaseException {
            return getResultSetCache("getUniqueConstraints").get(new ResultSetCache.ResultSetExtractor(database) {
                ...
                @Override
                public ResultSet bulkFetch() throws SQLException, DatabaseException {
