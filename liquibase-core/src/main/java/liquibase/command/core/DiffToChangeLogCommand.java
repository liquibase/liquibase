...
public class DiffToChangeLogCommand extends DiffCommand {
    ...
    protected void outputBestPracticeMessage() {
        LogService.getLog(getClass()).info(LogType.USER_MESSAGE, "BEST PRACTICE: The changelog generated by diffChangeLog/generateChangeLog should be inspected for correctness and completeness before being deployed");
    }
