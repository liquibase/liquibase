...
public class RollbackCountSQLCommand extends AbstractWrapperCommand {
    ...
    static {
        CommandArgumentDefinition.Builder builder = new CommandArgumentDefinition.Builder(RollbackCountSQLCommand.class);
