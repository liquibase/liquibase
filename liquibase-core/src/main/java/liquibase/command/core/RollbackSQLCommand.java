...
public class RollbackSQLCommand extends AbstractWrapperCommand {
    ...
    static {
        CommandArgumentDefinition.Builder builder = new CommandArgumentDefinition.Builder(RollbackSQLCommand.class);
