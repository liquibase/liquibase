...
public class UpdateCountSQLCommand extends AbstractWrapperCommand {
    ...
    static {
        CommandArgumentDefinition.Builder builder = new CommandArgumentDefinition.Builder(UpdateCountSQLCommand.class);
