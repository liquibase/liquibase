...
public class InternalSyncHubCommandStep extends AbstractCommandStep {
    ...
    static {
        ...
        URL_ARG = builder.argument(CommandArgumentNames.URL, String.class).build();
        CHANGELOG_FILE_ARG = builder.argument(CommandArgumentNames.CHANGELOG_FILE, String.class).build();
