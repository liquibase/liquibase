...
public class FulltextConstraint extends AbstractDatabaseObject {
    ...
    public FulltextConstraint(String name, String tableCatalog, String tableSchema, String tableName, String... columns) {
        this();
        setName(name);
	...
	@Override
    public FulltextConstraint setName(String constraintName) {
	...
	public FulltextConstraint setTable(Table table) {
    ...
    public FulltextConstraint setColumns(String columnNames) {
        this.getColumns().addAll(StringUtils.splitAndTrim(columnNames, ","));
        return this;
    }

    public FulltextConstraint addColumn(int position, String columnName) {
	...
	public FulltextConstraint setDeferrable(boolean deferrable) {
	...
	public FulltextConstraint setInitiallyDeferred(boolean initiallyDeferred) {
	...
	public FulltextConstraint setDisabled(boolean disabled) {
    ...
    public FulltextConstraint setBackingIndex(Index backingIndex) {
	...
	public boolean equals(Object o) {
		...
		if (null == this.getColumnNames())
			return false;
		FulltextConstraint that = (FulltextConstraint) o;
    ...
    public int compareTo(Object other) {
        FulltextConstraint o = (FulltextConstraint) other;
