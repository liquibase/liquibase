 ...
 * Implementations should only perform outside interaction from within the {@link #query( liquibase.Scope)} method.
 */
public interface QueryAction extends Action {
    ...
    public static class Result {
        ...
        public Result(Object singleValue) {
            if (singleValue == null) {
