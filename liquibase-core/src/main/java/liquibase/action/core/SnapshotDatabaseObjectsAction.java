 ...
 * The {@link liquibase.action.core.SnapshotDatabaseObjectsAction.Attr#typeToSnapshot} parameter contains the type of object to snapshot.
 * The {@link liquibase.action.core.SnapshotDatabaseObjectsAction.Attr#relatedTo} parameter contains the object for which all the given typeToSnapshot objects should be related to.
...
public class SnapshotDatabaseObjectsAction extends AbstractAction implements QueryAction{
    ...
    public SnapshotDatabaseObjectsAction(Class<? extends DatabaseObject> typeToLookup, DatabaseObject relatedTo) {
        this.set(Attr.typeToSnapshot, typeToLookup);
        this.set(Attr.relatedTo, relatedTo);
    }
}
