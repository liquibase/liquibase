...
public class LicenseServiceUtils {
  ...
  private static final String BASE_INVALID_LICENSE_MESSAGE = "Using '%s' requires a valid Liquibase Pro or EMPIRE license. Get a free license key at " + TRIAL_LICENSE_URL + ".";
