...
public final class CheckSum {
    public static final int CURRENT_CHECKSUM_ALGORITHM_VERSION = 7;
    private int version;
    ...
    /**
     * Compute a CheckSum of the given data stream and ensure that different line endings (\r\n on Windows vs.
     * \n on Unixes) do not influence the resulting checksum.
     */
    public static CheckSum computeWithEolStandardization(final InputStream stream) {
        InputStream newStream;

        // A modification for the InputStream that causes \r\n to be read as \n
        newStream = new InputStream() {
            private int previousChar = 'X';
            ...
            public int read() throws IOException {
                ...
                // Make the current (unmodified) character the "previous" character in preparation for the next
                // iteration.
                previousChar = read;
