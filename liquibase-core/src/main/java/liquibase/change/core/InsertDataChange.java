...
//            }
        ...
        if (needsPreparedStatement) {
            return new SqlStatement[] {
                    new InsertExecutablePreparedStatement(options, catalogName, schemaName, tableName, columns, getChangeSet(), this.getResourceAccessor())
            };
        }
        ...
        for (ColumnConfig column : columns) {
        	...
        	if (options.getRuntimeEnvironment().getTargetDatabase().supportsAutoIncrement()
