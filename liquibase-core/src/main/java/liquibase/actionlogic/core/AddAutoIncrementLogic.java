...
//            }
    ...
    protected StringClauses generateSql(AddAutoIncrementAction action, Scope scope) {
        ...
        clauses.append(Clauses.autoIncrement, generateAutoIncrementClause(action.startWith, action.incrementBy));
    ...
    public StringClauses generateAutoIncrementClause(BigInteger startWith, BigInteger incrementBy) {
        ...
        if (startWith != null) {
            autoIncrementDetails.append("startWith", "START WITH "+startWith);
        }
        if (incrementBy != null) {
            autoIncrementDetails.append("incrementBy", "INCREMENT BY "+incrementBy);
        }
