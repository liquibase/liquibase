...
public class AddAutoIncrementLogic extends AbstractSqlBuilderLogic<AddAutoIncrementAction> {
    ...
    public static enum Clauses {
        autoIncrementMarker, autoIncrementDetails, autoIncrementDetailsStartWith, autoIncrementDetailsIncrementBy, dataType
    }
...
//            }
    ...
    protected StringClauses generateSql(AddAutoIncrementAction action, Scope scope) {
        ...
        clauses.append(Clauses.autoIncrementMarker, "GENERATED BY DEFAULT AS IDENTITY");

        StringClauses autoIncrementDetails = new StringClauses("(", " ", ")");
        if (action.startWith != null) {
            autoIncrementDetails.append(Clauses.autoIncrementDetailsStartWith, "START WITH "+action.startWith);
        }
        if (action.incrementBy != null) {
            autoIncrementDetails.append(Clauses.autoIncrementDetailsIncrementBy, "INCREMENT BY "+action.incrementBy);
        }
        clauses.append(Clauses.autoIncrementDetails, autoIncrementDetails);
