...
public class AbstractExtensibleObject implements ExtensibleObject {
     ...
     */
    private static Map<Class<? extends AbstractExtensibleObject>, Map<String, Field>> attributeFieldCache = new ConcurrentHashMap<>();
            ...
            for (String attr : getAttributes()) {
                ...
                if (value instanceof Collection) {
                    try {
                        ...
                        valueClone.addAll(((Collection) value));
                        value = valueClone;
                    } catch (Exception e) {
